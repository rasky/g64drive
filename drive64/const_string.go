// Code generated by "stringer -type=Cmd,Bank,CIC,UpgradeStatus -output=const_string.go"; DO NOT EDIT.
...
const (
	...
	_Cmd_name_4 = "CmdUpgradeStartCmdUpgradeReport"
)

var (
	_Cmd_index_4 = [...]uint8{0, 15, 31}
)
...
func (i Cmd) String() string {
	...
	case 132 <= i && i <= 133:
		i -= 132
		return _Cmd_name_4[_Cmd_index_4[i]:_Cmd_index_4[i+1]]
	default:
